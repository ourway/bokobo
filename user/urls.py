from user.controllers.user import add as add_user, get, get_all, delete, edit, get_profile, edit_profile, forget_pass
...
def call_router(app):
    ...
    app.route('/users/forget-password', 'POST', forget_pass, apply=[inject_db,jsonify,pass_data])
